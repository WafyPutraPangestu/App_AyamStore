    ...
    <div class="min-h-screen bg-gray-50">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                @foreach ($katalog as $item)
                    ...
                    >
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">{{ $item->nama_produk }}</h3>
                            <p class="text-lg font-semibold text-indigo-600">
                                Rp {{ number_format((float)str_replace('.', '', $item->harga), 0, ',', '.') }}
                            </p>
                        </div>
                    </div>
                @endforeach
        ...
        <div 
            x-data="{ 
                ...
                quantity: 1,
                imageBasePath: '{{ asset('storage/images') }}/'
            }"
            x-show="showModal"
            ...
            >
                <div class="bg-white rounded-3xl shadow-2xl p-6">
                    ...
                    <div class="flex gap-4 mb-6">
                        <img 
                            :src="imageBasePath + selectedProduct?.gambar"
                    ...
                    <!-- Order Form -->
                    <form method="POST" action="{{ route('user.katalog') }}" class="space-y-6">
                        @csrf
                        <div>
                        ...
                        <div class="flex justify-center">
                            <button
                                type="submit"
                                class="flex-1 bg-emerald-600 text-white py-3 rounded-xl font-semibold hover:bg-emerald-700 transition-colors cursor-pointer"
                            >
                                Add to Cart
                            </button>
                        </div>
