...
<div x-data="{ show: false }" x-init="() => { setTimeout(() => show = true, 50) }" class="mb-8 border-b border-gray-200 pb-5">
    <div class="flex justify-between items-center">
        ...
        <div x-show="show"
            ...
            <div class="h-0.5 w-24 bg-gradient-to-r from-blue-500 to-orange-500 rounded-full"></div>
        </div>
        ...
        <div x-show="show"
             ...
             x-transition:enter-end="opacity-100 translate-y-0">
            <a href="{{ $buttonLink }}"
               class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-500 to-blue-500 text-white rounded-lg shadow-md
                      hover:from-amber-600 hover:to-blue-600 hover:shadow-lg
